...
describe('categorizeFromFilename', () => {
  it.each([
    ...
    ['Rocky Hill Amsterdam BV FS 31.12.2024.pdf', 'financial_statements'],
    ['jaarverslag 2023.pdf',           'financial_statements'],
    ['Balance Sheet 2024.xlsx',        'financial_statements'],
    ['P&L 2023.xlsx',                  'financial_statements'],
    ['Profit and Loss 2024.pdf',       'financial_statements'],
    ['aangifte-vpb-2024.pdf',          'tax_returns'],
    ['VPB Return 2023.pdf',            'tax_returns'],
    ['corporate_tax_filing.pdf',       'tax_returns'],
    ['S4 Energy BV - 2023-2024 CIT return .pdf', 'tax_returns'],
    ['Corporate Income Tax 2023.pdf',  'tax_returns'],
    ['vennootschapsbelasting 2024.pdf', 'tax_returns'],
    ['Income tax return 2023.pdf',     'tax_returns'],
    ...
    ['S4 Energy B.V. - 2023-2024 CIT Comment letter (final).pdf', 'comment_letter_to_tax_return'],
