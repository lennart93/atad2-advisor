...
export const APPENDIX_SKELETON: SkeletonRow[] = [
  ...
  { rowId: '6.2', sectionId: '6', sectionTitle: S6, legalBasis: 'Article 12ad CIT Act', conditionTested: 'There is a hybrid mismatch (double deduction or deduction without inclusion) elsewhere in the structure', effect: null, kind: 'gate', allowedStates: STATUS, drivenByQuestionIds: ['Q9', 'Q10'], relatedView: 'none' },
  ...
  { rowId: '8.1', sectionId: '8', sectionTitle: S8, legalBasis: 'Article 2 CIT Act', conditionTested: 'A related participant regards the Dutch partnership as non-transparent (independently taxable) while the Netherlands treats it as transparent (reverse-hybrid classification conflict)', effect: null, kind: 'gate', allowedStates: STATUS, drivenByQuestionIds: ['Q4'], relatedView: 'none' },
