      ...
      <div className="space-y-2">
        ...
        >
          <input
            ...
            id={id}
            type="text"
            className="flex-[2] bg-transparent outline-none placeholder:text-muted-foreground disabled:cursor-not-allowed min-w-0"
            placeholder="email"
            value={localPart}
          ...
          >
            <SelectTrigger 
              className="w-auto bg-transparent border-0 shadow-none focus:ring-0 hover:bg-accent/50 h-auto p-0 gap-0 [&>svg]:hidden"
