// Deno copy of src/lib/factsheet/buildFactsheetBlock.ts (WP1).
// DUAL MAINTENANCE — keep IN SYNC with that frontend canonical (body identical;
// only the Factsheet import path differs). Used by generate-appendix to inject
// the {{FACTSHEET_BLOCK}} into the facts-call and the Part B section swarm.
import type { Factsheet } from "../_shared/factsheetSchema.ts";
