...
-- classification). Everything else is identical to v7 (answer-independent Part A,
-- fiscalUnityMemberEntityIds, KB grounding, hard rules, all other placeholders).
...
Return ONLY a JSON object: {"nlTaxStatusByEntityId":{...},"fiscalUnityMemberEntityIds":[...],"actingTogether":[{"memberEntityIds":[...],"combinedPct":..,"likelihood":"..","rationales":{"highly_unlikely":"..","unlikely":"..","unclear":"..","likely":"..","highly_likely":".."}}],"transactions":[{"fromEntityId":"..","toEntityId":"..","kind":"..","instrument":"..","note":"..","articlesTested":[...],"relevant":true,"relevanceReason":".."}],"classifications":[...],"narratives":{"register":"..","related":"..","flows":"..","classification":".."}}
